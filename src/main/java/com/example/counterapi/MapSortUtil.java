...
public class MapSortUtil {
    ...
    private static Comparator<Map.Entry> comparatorByKeyAsc = (Map.Entry o1, Map.Entry o2) -> {
        ...
        throw new UnsupportedOperationException("The type of the key does not implement the comparable interface");
    };
    ...
    private static Comparator<Map.Entry> comparatorByValueAsc = (Map.Entry o1, Map.Entry o2) -> {
        ...
        throw new UnsupportedOperationException("The type of the value does not implement the comparable interface");
    };
